...
const ESSAYS = [
  { q:"Under what conditions might a citizen use Voice vs. Exit vs. Loyalty?", hint:"Voice: when exit is costly, loyalty is moderate, voice feels effective.\nExit: when alternatives exist, cost of leaving is low, voice seems futile.\nLoyalty: when attachment is high, exit isn't feasible, hope remains.\nKey driver: credibility of the exit option.", example:"Imagine your favorite restaurant goes downhill — you can complain to the manager (voice), just stop going (exit), or keep eating there because you've always loved the place (loyalty). Same logic with citizens and their government: if leaving is hard or expensive, people complain and try to fix things instead. If voting feels useless and they can easily move countries or jobs, they exit. If they're emotionally tied to the place, they put up with the dysfunction and just hope it improves." },
  { q:"What is the collective action dilemma? Why does it predict low individual participation?", hint:"Each individual's contribution is too small to matter alone → rational to free-ride.\nBut if everyone free-rides → collective good (political change) is not provided.\nSolution: selective incentives, social pressure, expressive benefits.", example:"Picture 10,000 people who all want the same law passed, but each one thinks 'my single signature won't matter, somebody else will handle it.' Everyone reasons that way, so nobody acts, and the thing they all wanted never happens. This is why turnout at protests, polls, and donation drives is way lower than the actual support for the cause. The fix is giving people a personal reason to show up — free pizza, peer pressure, or just the good feeling of being seen there." },
  { q:"Why do people bother to vote at all?", hint:"1. Civic duty / expressive voting\n2. Social pressure / norms\n3. Selective incentives (party mobilization)\n4. Close elections raise perceived impact\n5. Low cost of voting (habits, proximity)\n6. Partisan identity drives turnout", example:"Mathematically your single vote almost never decides an election, so a strict cost-benefit person wouldn't bother showing up. But millions show up anyway because it feels like a civic duty, their friends are voting, the party called them, or being a Democrat or Republican is part of who they are. Close elections also juice turnout because people feel their vote actually matters that time. So voting is mostly about identity, habits, and social pressure — not raw math." },
  { q:"Why is SES often positively correlated with political participation?", hint:"Higher SES → more resources (time, money, civic skills), more political information, more policy stakes, more party mobilization.", example:"Rich, educated people vote, protest, and donate more than poor people do — and this pattern shows up almost everywhere you look. They have the time, money, and confidence to engage, and they soak up political info just from their environment and friends. Politicians target them harder too, because they're easier to reach and far more likely to donate. Plus they have more concrete stakes when tax, zoning, or property laws shift." },
  { q:"Under what conditions might SES NOT be positively correlated with participation?", hint:"Authoritarian contexts: poor mobilized by clientelism or fear.\nStrong ethnic/communal mobilization: identity overrides class.\nExtreme grievance: high-intensity movements mobilize low-SES groups.\nInverse: wealthy exit (private solutions) rather than engage politically.", example:"In a dictatorship, poor people often dominate protests because the regime literally pays them to attend rallies, or because they have nothing left to lose. Sometimes ethnic or religious identity overrides class, and a poor villager mobilizes hard for their group regardless of income. In other cases, rich people opt out of politics entirely — private schools, gated communities, and lawyers handle their problems for them. So the SES link breaks whenever something else (fear, identity, or exit) is doing the heavier work." },
  { q:"What does ethnic diversity suggest for democratic politics?", hint:"Not deterministic. Problems arise IF: reinforcing cleavages, ethnicity is politicized, weak institutions.\nLess damaging when: cross-cutting cleavages, constructivist fluidity, strong party systems.\nEthnic fractionalization alone doesn't predict democratic breakdown.", example:"Having lots of ethnic groups doesn't automatically break democracy — Switzerland, Canada, and India all manage just fine. Trouble starts when every social split (class, religion, ethnicity) lines up the same way, turning every election into a zero-sum tribal fight. It also helps when institutions are strong and identities can shift over time rather than being treated as fixed and inherited. So diversity itself isn't the problem — it's whether the divisions reinforce each other and whether elites politicize them." },
  { q:"What evidence suggests partisanship is a social identity rather than a rational running tally?", hint:"Stability across dramatic party policy shifts.\nAffective polarization beyond policy disagreement.\nParty preference precedes policy views (not the reverse).\nIntermarriage preferences, social sorting by party.", example:"If party loyalty were just rational scorekeeping, people would switch parties when their party flipped on major issues — but in reality, they almost never do. Republicans stayed Republican when the party reversed on free trade; Democrats stayed when their party's stances drifted too. People also hate the other party way more than the actual policy disagreement would justify, and they don't even want their kids dating across party lines. That's tribal team-loyalty, not a running scorecard of policy outcomes." },
  { q:"Why do some countries have more parties than others?", hint:"1. Electoral system: PR → more parties (Duverger's Law)\n2. Social cleavages: more distinct groups → more parties\n3. Low legal thresholds\n4. Federalism: regional parties viable\n5. Historical path dependence", example:"Countries with winner-take-all elections (like the US and UK) end up with two parties, because voting for a third basically wastes your vote. Countries with proportional representation (like Germany or Israel) reward smaller parties with actual seats, so you end up with five, eight, or even ten of them competing. The number of social divisions matters too — lots of regional, religious, or ethnic groups means more parties trying to represent each one. And once a party system locks in, voters and elites stick with it out of habit." },
  { q:"How would you assess whether a country has high party system institutionalization?", hint:"1. Low electoral volatility (stable vote shares)\n2. Parties have roots in society (not just leader vehicles)\n3. Parties seen as legitimate actors\n4. Parties have strong internal organizations\n(Mainwaring & Scully's 4 dimensions)", example:"A well-rooted party system is one where the same parties show up election after election, voters know what each one stands for, and they aren't just one celebrity's personal vehicle. If 30% of voters bounce to brand-new parties every cycle, that's a red flag for instability. Parties should also have real organizations, local branches, and members — not just a logo and a leader on TV. When voters and elites both treat the parties as legitimate fixtures of political life, the system is institutionalized." },
  { q:"Why is electoral fraud difficult to measure?", hint:"It's hidden by definition. Methods: expert surveys (PEI), digit-based forensics (Benford's Law), turnout anomalies, precinct-level outliers, satellite imagery, observer reports.\nLimitation: forensic stats produce false positives; surveys are subjective.", example:"Cheating in elections is famously hard to measure because the people doing it are hiding it on purpose. Researchers use clever workarounds: digit-based statistics (Benford's Law), suspicious turnout spikes in single precincts, or expert surveys that rank each country's elections. None of these are bulletproof — sometimes a weird statistic is just a weird statistic, not fraud. So estimates of how much fraud happens in any given election are rough and openly contested." },
];
